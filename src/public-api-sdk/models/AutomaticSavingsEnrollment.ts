...
export function instanceOfAutomaticSavingsEnrollment(value: object): value is AutomaticSavingsEnrollment {
    ...
    if (!('automaticSavingsEligible' in value) || value['automaticSavingsEligible'] === undefined) return false;
    if (!('automaticSavingsActive' in value) || value['automaticSavingsActive'] === undefined) return false;
    return true;
}
...
export function AutomaticSavingsEnrollmentFromJSONTyped(json: any, ignoreDiscriminator: boolean): AutomaticSavingsEnrollment {
    ...
    return {
        ...
        'sourceAccount': AccountFromJSON(json['source_account']),
        'destinationAccount': AccountFromJSON(json['destination_account']),
        'automaticSavingsEligible': json['automatic_savings_eligible'],
        'automaticSavingsActive': json['automatic_savings_active'],
    };
}
