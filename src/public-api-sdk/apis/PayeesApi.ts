...
export class PayeesApi extends runtime.BaseAPI {
    ...
    /**
     * Creates a bill payment payee via third-party integration (typically iPay). Payees can be used to create payments via the <a href=\"#tag/payments\">payments endpoints</a>.
    ...
    /**
     * Delete a specified bill payment payee via third-party integration (typically iPay).Payees can be used to create payments via the <a href=\"#tag/payments\">payments endpoints</a>.
    ...
    /**
     * List bill payment payees for a user. Payees can be used to create payments via the <a href=\"#tag/payments\">payments endpoints</a>.
    ...
    /**
     * Fetch a specified bill payment payee.Payees can be used to create payments via the <a href=\"#tag/payments\">payments endpoints</a>.
    ...
    /**
     * Update fields for a specified bill payment payee via third-party integration (typically iPay).Payees can be used to create payments via the <a href=\"#tag/payments\">payments endpoints</a>.
