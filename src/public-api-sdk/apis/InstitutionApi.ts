...
export class InstitutionApi extends runtime.BaseAPI {
     ...
     */
    async gETCurrentInstitutionRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SwaggerInstitutionGet>> {
     ...
     * Get current institution info
     */
    async gETCurrentInstitution(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SwaggerInstitutionGet> {
        const response = await this.gETCurrentInstitutionRaw(initOverrides);
