...
export class InstitutionApi extends runtime.BaseAPI {
    ...
    /**
     * Return configurable data for the active Institution, such as URLs, asset URLs, and customizable settings.   For brevity, only a subset of returned fields are listed in the example response shown.  Authentication required:  - None  Security required:  - None    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
