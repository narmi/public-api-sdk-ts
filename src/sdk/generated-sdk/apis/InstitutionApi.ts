...
export class InstitutionApi extends runtime.BaseAPI {
    ...
    /**
     * Return configurable data for the active Institution, such as URLs, asset URLs, and customizable settings.   For brevity, only a subset of returned fields are listed in the example response shown.  Authentication required:  - None  Security required:  - None  All monetary values are represented in minor units, or the smallest unit of the currency with no decimal (e.g., cents). For example, $10.00 is represented as 1000.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
