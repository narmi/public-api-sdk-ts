...
export class ThreadsApi extends runtime.BaseAPI {
    ...
    /**
     * Create a support message thread for the authenticated user.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * List support message threads for the authenticated user.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * Mark the specified support message thread as read.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * Fetch a specified message on the specified support message thread. This request will not return thread files (i.e. attachments).    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * Fetch a specified support message thread.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     * Retrieve a thread
     */
    ...
    /**
     * Mark a specified support message thread as closed or open.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * Create a message on the specified support message thread as the authenticated user.   Define either `body` or `url` in the request to create a message or attachment, respectively.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
