...
import {
    ...
    UploadPolicyCreateDocRequestFromJSON,
    UploadPolicyCreateDocRequestToJSON,
    UploadPolicyResponseFromJSON,
    UploadPolicyResponseToJSON,
} from '../models/index';

export interface ThreadFilesPoliciesCreateRequest {
    uploadPolicyCreateDocRequest: UploadPolicyCreateDocRequest;
}
...
export class ThreadsApi extends runtime.BaseAPI {
     ...
     */
    async threadFilesPoliciesCreateRaw(requestParameters: ThreadFilesPoliciesCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UploadPolicyResponse>> {
        if (requestParameters['uploadPolicyCreateDocRequest'] == null) {
            throw new runtime.RequiredError(
                'uploadPolicyCreateDocRequest',
                'Required parameter "uploadPolicyCreateDocRequest" was null or undefined when calling threadFilesPoliciesCreate().'
            );
        }
        ...
        const response = await this.request({
            ...
            body: UploadPolicyCreateDocRequestToJSON(requestParameters['uploadPolicyCreateDocRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => UploadPolicyResponseFromJSON(jsonValue));
    }
     ...
     * Create a signed request for uploading a file to S3
     */
    async threadFilesPoliciesCreate(requestParameters: ThreadFilesPoliciesCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UploadPolicyResponse> {
