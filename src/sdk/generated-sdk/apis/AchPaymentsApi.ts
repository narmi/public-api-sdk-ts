 ...
 *
 * The version of the OpenAPI document: v1 (v2025.10.131)
...
export class AchPaymentsApi extends runtime.BaseAPI {
    ...
    /**
     * Send an ACH Payment using an existing recipient and set of external account details (i.e. account number, routing number, account type, account purpose).  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     * Send an ACH Payment
     */
    ...
    /**
     * List the authenticated user\'s ACH payments.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     * List ACH payments
     */
    ...
    /**
     * Fetch details for a specified ACH payment.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * List the authenticated user\'s scheduled ACH payments.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * Create an ACH payment from an external account to a loan.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
