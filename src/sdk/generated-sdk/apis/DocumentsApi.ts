...
export class DocumentsApi extends runtime.BaseAPI {
     ...
     */
    async documentsDownloadZipRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
     ...
     * Create zip file of selected documents
     */
    async documentsDownloadZip(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Blob> {
        const response = await this.documentsDownloadZipRaw(initOverrides);
