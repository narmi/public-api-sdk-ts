...
export interface DocumentsDownloadZipRequest {
    share?: DocumentsDownloadZipShareEnum;
}
...
export class DocumentsApi extends runtime.BaseAPI {
    ...
    /**
     * Creates a zip file of the requested document ids.  All monetary values are represented in minor units, or the smallest unit of the currency with no decimal (e.g., cents). For example, $10.00 is represented as 1000.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     * Create zip file of selected documents
     */
    async documentsDownloadZipRaw(requestParameters: DocumentsDownloadZipRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
     ...
     * Create zip file of selected documents
     */
    async documentsDownloadZip(requestParameters: DocumentsDownloadZipRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Blob | null | undefined > {
        const response = await this.documentsDownloadZipRaw(requestParameters, initOverrides);
 ...
 * @export
 */
export const DocumentsDownloadZipShareEnum = {
    NUMBER_1: 1
} as const;
export type DocumentsDownloadZipShareEnum = typeof DocumentsDownloadZipShareEnum[keyof typeof DocumentsDownloadZipShareEnum];
