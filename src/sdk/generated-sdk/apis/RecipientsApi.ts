...
export class RecipientsApi extends runtime.BaseAPI {
    ...
    /**
     * Create a recipient that can be used as a destination for wires or ACH payments.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     * Create a recipient
     */
    ...
    /**
     * Delete a specified recipient belonging to the user. The recipient will continue to exist in the database, but won\'t be retrievable by the user. The name of the deleted recipient will be available for use in creating a new recipient.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     * Delete a recipient
     */
    ...
    /**
     * List a user\'s recipients, including recipients created by other users in their organization.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     * List recipients
     */
    ...
    /**
     * Fetch details for a specified recipient.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * Update the details of a recipient belonging to authenticated user, identified by `uuid`  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     * Update a recipient
     */
