...
export class DepositsApi extends runtime.BaseAPI {
    ...
    /**
     * Fetch a specified deposit by deposit ID. This identifier is defined via the check deposit integration, e.g. Ensenta.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     * Retrieve deposit
     */
