...
export class TransfersApi extends runtime.BaseAPI {
    ...
    /**
     * Transfer funds between two accounts. The target accounts should be either an account at the financial institution belonging to the user or a verified external account.  A list of eligible accounts can be retrieved or listed from the accounts endpoints.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     * Create a transfer
     */
