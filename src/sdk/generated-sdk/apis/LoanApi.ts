...
export class LoanApi extends runtime.BaseAPI {
    ...
    /**
     * Activates a loan alert for the user. The `alert_key` field determines which alert to activate for the user.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     * Create a loan alert
     */
    ...
    /**
     * Deactivates a loan alert for the user. The `alert_key` field determines which alert to deactivate for the user.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     * Delete a loan alert
     */
    ...
    /**
     * List all active loan alerts for the user.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     * List loan alerts
     */
    ...
    /**
     * Retrieves a loan alert for the user  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * Updates a loan alert\'s metadata for the user  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     * Update a loan alert
     */
