...
export class SupportApi extends runtime.BaseAPI {
    ...
    /**
     * Supplies information on support contacts, faqs, links, and expected support response time.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     * List support info
     */
