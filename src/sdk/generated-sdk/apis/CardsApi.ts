...
export interface CardsAndroidProvisioningCreateRequest {
    cardId: string;
}

export interface CardsIosProvisioningCreateRequest {
    cardId: string;
}
...
export class CardsApi extends runtime.BaseAPI {
     ...
     */
    async cardsAndroidProvisioningCreateRaw(requestParameters: CardsAndroidProvisioningCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['cardId'] == null) {
            throw new runtime.RequiredError(
                'cardId',
                'Required parameter "cardId" was null or undefined when calling cardsAndroidProvisioningCreate().'
            );
        }
        ...
        const response = await this.request({
            path: `/v1/cards/{card_id}/android_provisioning`.replace(`{${"card_id"}}`, encodeURIComponent(String(requestParameters['cardId']))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     */
    async cardsAndroidProvisioningCreate(requestParameters: CardsAndroidProvisioningCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.cardsAndroidProvisioningCreateRaw(requestParameters, initOverrides);
    }

    /**
     * <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     */
    async cardsIosProvisioningCreateRaw(requestParameters: CardsIosProvisioningCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['cardId'] == null) {
            throw new runtime.RequiredError(
                'cardId',
                'Required parameter "cardId" was null or undefined when calling cardsIosProvisioningCreate().'
            );
        }
        ...
        const response = await this.request({
            path: `/v1/cards/{card_id}/ios_provisioning`.replace(`{${"card_id"}}`, encodeURIComponent(String(requestParameters['cardId']))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     */
    async cardsIosProvisioningCreate(requestParameters: CardsIosProvisioningCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.cardsIosProvisioningCreateRaw(requestParameters, initOverrides);
    }
