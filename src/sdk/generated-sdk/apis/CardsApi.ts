...
export class CardsApi extends runtime.BaseAPI {
     ...
     */
    async cardsSubscriptionsRetrieveRaw(requestParameters: CardsSubscriptionsRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<CardSubscriptions>>> {
        if (requestParameters['cardId'] == null) {
            throw new runtime.RequiredError(
                'cardId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(CardSubscriptionsFromJSON));
    }
     ...
     * Retrieve card subscriptions
     */
    async cardsSubscriptionsRetrieve(requestParameters: CardsSubscriptionsRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<CardSubscriptions>> {
