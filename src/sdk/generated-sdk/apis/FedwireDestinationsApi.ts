...
export class FedwireDestinationsApi extends runtime.BaseAPI {
    ...
    /**
     * Create a set of Fedwire details that can be used as a destination for fedwires.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * Update a set of Fedwire details that can be used as a destination for fedwires.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
