...
export class FedwireDestinationsApi extends runtime.BaseAPI {
    ...
    /**
     * Update a set of Fedwire details that can be used as a destination for fedwires.  All monetary values are represented in minor units, or the smallest unit of the currency with no decimal (e.g., cents). For example, $10.00 is represented as 1000.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
