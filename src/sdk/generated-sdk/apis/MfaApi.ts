...
export class MfaApi extends runtime.BaseAPI {
    ...
    /**
     * Delete a user\'s MFA device.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     * Delete MFA device
     */
    ...
    /**
     * List the authenticated user\'s MFA devices.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     * List MFA devices
     */
    ...
    /**
     * Elevate user permissions using Two-Factor-Authentication.     Send a `device_id` to generate and dispatch a one-time-password to the specified device.     Send `device_id` and `one_time_password` to validate the OTP sent to a user.     The endpoint will return a `403` if there is an issue with the `device_id` or `one_time_password`, or if the user has no registered 2FA devices.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * Retrieve information on whether the current user has sudo permissions.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
