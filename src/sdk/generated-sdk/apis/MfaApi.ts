...
export interface MfaDestroyRequest {
    id: string;
    format?: MfaDestroyFormatEnum;
}

export interface MfaListRequest {
    format?: MfaListFormatEnum;
    limit?: number;
    offset?: number;
}
 ...
 * @export
 */
export const MfaDestroyFormatEnum = {
    Html: 'html',
    Json: 'json'
} as const;
export type MfaDestroyFormatEnum = typeof MfaDestroyFormatEnum[keyof typeof MfaDestroyFormatEnum];
/**
 * @export
 */
export const MfaListFormatEnum = {
    Html: 'html',
    Json: 'json'
} as const;
export type MfaListFormatEnum = typeof MfaListFormatEnum[keyof typeof MfaListFormatEnum];
