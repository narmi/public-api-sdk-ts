...
export class WireRecipientsApi extends runtime.BaseAPI {
    ...
    /**
     * Create a new wire recipient for the authenticated user to be referenced in wire transfers.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * Delete an authenticated user\'s wire recipient identified by `uuid`  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * Returns a list of the authenticated user\'s previous wire recipients. They are persisted so the user may easily reference them for future wire transfers.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * Update the details of a wire recipient belonging to authenticated user, identified by `uuid`  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * Returns wire recipient belonging to authenticated user, identified by `uuid`  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
