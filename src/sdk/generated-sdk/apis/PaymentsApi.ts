...
export class PaymentsApi extends runtime.BaseAPI {
    ...
    /**
     * Creates a bill pay payment for the authenticated user (distinct from ACH, wire, or other transfers). Payments use a third-party service (typically iPay) and transfers can execute from a user\'s account to a specified payee.  All monetary values are represented in minor units, or the smallest unit of the currency with no decimal (e.g., cents). For example, $10.00 is represented as 1000.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * Deletes an authenticated user\'s bill payment via the third-party integration (typically iPay).  All monetary values are represented in minor units, or the smallest unit of the currency with no decimal (e.g., cents). For example, $10.00 is represented as 1000.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * List the authenticated user\'s bill pay payments (distinct from ACH, wire, or other transfers). Payments use a third-party service (typically iPay) and represent transfers from a user\'s account to a specified payee.  All monetary values are represented in minor units, or the smallest unit of the currency with no decimal (e.g., cents). For example, $10.00 is represented as 1000.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     * List bill payments
     */
