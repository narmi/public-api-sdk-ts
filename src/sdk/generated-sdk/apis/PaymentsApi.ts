...
export class PaymentsApi extends runtime.BaseAPI {
    ...
    /**
     * Creates a bill payment for the authenticated user.Payments use a third-party service (typically iPay) and transfers can execute from a user\'s account to a specified payee.  All monetary values are represented in minor units, or the smallest unit of the currency with no decimal (e.g., cents). For example, $10.00 is represented as 1000.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * List the authenticated user\'s bill payments. Payments use a third-party service (typically iPay) and represent transfers from a user\'s account to a specified payee.  All monetary values are represented in minor units, or the smallest unit of the currency with no decimal (e.g., cents). For example, $10.00 is represented as 1000.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
     * List bill payments
     */
