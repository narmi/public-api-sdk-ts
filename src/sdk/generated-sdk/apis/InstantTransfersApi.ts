...
export class InstantTransfersApi extends runtime.BaseAPI {
    ...
    /**
     * Check if the provided routing number is enrolled and active in the FedNow network  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * Returns the fee structure for instant transfers to calculate the fee for any transfer.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * Retrieve the details and status for an instant transfer. This is only supported for payments that have been assigned a payment ID.  All dollar amounts are represented in cents.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
