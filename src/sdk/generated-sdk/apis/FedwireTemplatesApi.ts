 ...
 *
 * The version of the OpenAPI document: v1 (v2025.5.126)
...
export class FedwireTemplatesApi extends runtime.BaseAPI {
    ...
    /**
     * Create a template that can be used to send wires.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * Delete a specified template belonging to the user. The template will continue to exist in the database, but won\'t be retrievable by the user. The name of the deleted template will be available for use in creating a new template.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * List a user\'s templates, including templates created by other users in their organization. Templates will only be included in the returned list where the user has access to the template\'s source account.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * Update the details of a template belonging to authenticated user, identified by `uuid`    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
    ...
    /**
     * Fetch details for a specified template.    <i>How can we improve these docs?             <a href=\"mailto:docs+feedback@narmi.com\">Share your feedback.</a></i>
