...
import {
    ...
    IncomeSourceFromJSONTyped,
    IncomeSourceToJSON,
} from './IncomeSource';
import type { UserCategory4f2Enum } from './UserCategory4f2Enum';
import {
    UserCategory4f2EnumFromJSON,
    UserCategory4f2EnumFromJSONTyped,
    UserCategory4f2EnumToJSON,
} from './UserCategory4f2Enum';
...
export interface Profile {
    ...
    /**
     * 
     * @type {UserCategory4f2Enum}
     * @memberof Profile
     */
    userCategory?: UserCategory4f2Enum | null;
    /**
    ...
    /**
     * For business users, this field indicates whether wire transactions initiated by the user require approval from the organization. For non-business users this will always be set to `false`.
     * @type {boolean}
     * @memberof Profile
     */
    readonly dualApprovalRequired?: boolean | null;
    /**
     * For business users, this field indicates whether ACH transactions initiated by the user require approval from the organization. For non-business users this will always be set to `false`.
     * @type {boolean}
     * @memberof Profile
     */
    readonly achDualApprovalRequired?: boolean | null;
    /**
     * For business users, this field indicates whether the user is exempt from dual approval when creating payments. For non-business users this will always be set to `false`.
     * @type {boolean}
     * @memberof Profile
     */
    readonly dualApprovalAdminExemption?: boolean;
    /**
     * A list of user reported income sources.
     * @type {Array<IncomeSource>}
     * @memberof Profile
     */
    readonly incomeSources?: Array<IncomeSource>;
    /**
     * For business users, this field indicates whether international wire transactions initiated by the user require approval from the organization. For non-business users this will always be set to `false`.
     * @type {boolean}
     * @memberof Profile
     */
    readonly internationalWireDualApprovalRequired?: boolean | null;
    /**
    ...
    /**
     * Whether the user has accepted the SMS transactional alerts disclosure.
     * @type {boolean}
     * @memberof Profile
     */
    readonly hasAcceptedTransactionalSms?: boolean;
    /**
    ...
    /**
     * The UUIDs of the support teams which the user belongs to. This will be set to `null` if the user does not belong to a support team.
     * @type {Array<string>}
     * @memberof Profile
     */
    readonly supportTeams?: Array<string> | null;
    /**
     * The OIDC provider associated with the user's current session, if any.
     * @type {string}
     * @memberof Profile
     */
    readonly sessionOidcProvider?: string | null;
}
...
export function ProfileFromJSONTyped(json: any, ignoreDiscriminator: boolean): Profile {
    ...
    return {
        ...
        'userCategory': json['user_category'] == null ? undefined : UserCategory4f2EnumFromJSON(json['user_category']),
        ...
        'achDualApprovalRequired': json['ach_dual_approval_required'] == null ? undefined : json['ach_dual_approval_required'],
        'dualApprovalAdminExemption': json['dual_approval_admin_exemption'] == null ? undefined : json['dual_approval_admin_exemption'],
        'incomeSources': json['income_sources'] == null ? undefined : ((json['income_sources'] as Array<any>).map(IncomeSourceFromJSON)),
        'internationalWireDualApprovalRequired': json['international_wire_dual_approval_required'] == null ? undefined : json['international_wire_dual_approval_required'],
        ...
        'hasAcceptedTransactionalSms': json['has_accepted_transactional_sms'] == null ? undefined : json['has_accepted_transactional_sms'],
        ...
        'supportTeams': json['support_teams'] == null ? undefined : json['support_teams'],
        'sessionOidcProvider': json['session_oidc_provider'] == null ? undefined : json['session_oidc_provider'],
    };
}

export function ProfileToJSON(value?: Omit<Profile, 'email'|'core_provided_email'|'username'|'id'|'institution_user_identifier'|'updated_at'|'addresses'|'phone_numbers'|'notifications_enabled'|'first_name'|'last_name'|'paper_statements'|'features'|'org_uuid'|'org_name'|'business_permissions'|'dual_approval_required'|'ach_dual_approval_required'|'dual_approval_admin_exemption'|'income_sources'|'international_wire_dual_approval_required'|'is_staff'|'is_active'|'is_superuser'|'is_narmi'|'date_joined'|'last_login'|'segment'|'metadata'|'has_username'|'has_password'|'has_accepted_latest_terms'|'has_accepted_transactional_sms'|'requires_enrollment_code_verification'|'is_converting'|'has_permitted_device'|'has_backup_codes'|'support_teams'|'session_oidc_provider'> | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'user_category': UserCategory4f2EnumToJSON(value['userCategory']),
