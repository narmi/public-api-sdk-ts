...
export interface Profile {
    ...
    /**
     * The UUID of the support team which the user belongs to. This will be set to `null` if the user does not belong to a support team.
     * @type {string}
     * @memberof Profile
     */
    readonly supportTeam?: string | null;
}
