...
export function ACHPaymentToJSON(value?: Omit<ACHPayment, 'id'|'created_at'|'updated_at'|'processed_at'|'state'|'display_state'|'is_reversible'|'reversal'|'company_id'|'company_name'|'external_account_details'|'transaction_type'> | null): any {
    if (value == null) {
        return value;
    }
    return {
