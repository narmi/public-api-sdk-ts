...
export function ACHPaymentToJSON(value?: Omit<ACHPayment, 'id'|'created_at'|'updated_at'|'processed_at'|'state'|'display_state'|'company_id'|'company_name'|'external_account_details'> | null): any {
    if (value == null) {
        return value;
    }
    return {
