...
import type { StateBd5Enum } from './StateBd5Enum';
import {
    StateBd5EnumFromJSON,
    StateBd5EnumFromJSONTyped,
    StateBd5EnumToJSON,
} from './StateBd5Enum';
...
export function CommonCardFromJSONTyped(json: any, ignoreDiscriminator: boolean): CommonCard {
    ...
    return {
        ...
        'state': json['state'] == null ? undefined : StateBd5EnumFromJSON(json['state']),
        'bin': json['bin'],
