...
import type { SyncedWithEnum } from './SyncedWithEnum';
import {
    SyncedWithEnumFromJSON,
    SyncedWithEnumFromJSONTyped,
    SyncedWithEnumToJSON,
} from './SyncedWithEnum';
...
import type { State973Enum } from './State973Enum';
import {
    State973EnumFromJSON,
    State973EnumFromJSONTyped,
    State973EnumToJSON,
} from './State973Enum';
...
export interface Account {
    ...
    /**
     * Account number used for ACH pull authorization disclosures.
     * @type {string}
     * @memberof Account
     */
    readonly achPullAuthorizationNumber?: string;
    /**
    ...
    /**
     * List of capabilities for the account. Dictates when and how money can be moved to and from the account. Can contain any of the values `transfer_destination`, `transfer_source`, `ach_destination`, `ach_source`, `check_order`, `stop_payment`, `check_withdrawal`, `external_loan_management`, `zero_balance`, `m2m_source`, `m2m_destination`, and `billpay_source`.
     * @type {Array<string>}
     * @memberof Account
     */
     ...
     * @memberof Account
     */
    readonly updatedFromSourceAt?: Date | null;
    /**
    ...
    /**
     * Organization associated with this account, if applicable.
     * @type {{ [key: string]: any; }}
     * @memberof Account
     */
    readonly organization?: { [key: string]: any; } | null;
    /**
     * 
     * @type {SyncedWithEnum}
     * @memberof Account
     */
    syncedWith?: SyncedWithEnum | null;
    /**
     * 
     * @type {SyncStatusEnum}
     * @memberof Account
...
export function AccountFromJSONTyped(json: any, ignoreDiscriminator: boolean): Account {
    ...
    return {
        ...
        'achPullAuthorizationNumber': json['ach_pull_authorization_number'] == null ? undefined : json['ach_pull_authorization_number'],
        ...
        'state': json['state'] == null ? undefined : State973EnumFromJSON(json['state']),
        ...
        'syncedWith': json['synced_with'] == null ? undefined : SyncedWithEnumFromJSON(json['synced_with']),
        'syncStatus': json['sync_status'] == null ? undefined : SyncStatusEnumFromJSON(json['sync_status']),
    };
}

export function AccountToJSON(value?: Omit<Account, 'name'|'nickname'|'id'|'number'|'ach_pull_authorization_number'|'type'|'product'|'updated_at'|'users'|'features'|'routing'|'loan_details'|'source'|'state'|'favorited'|'hidden'|'out_of_date'|'updated_from_source_at'|'check_micr'|'metadata'|'fi_name'|'created_at'|'verified'|'fi_svg'|'organization'> | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'synced_with': SyncedWithEnumToJSON(value['syncedWith']),
        'sync_status': SyncStatusEnumToJSON(value['syncStatus']),
    };
}
