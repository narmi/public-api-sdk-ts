...
export interface AccountBalance {
    ...
    /**
     * The balance to be presented to the customer. Set to the available balance for non CD deposit accounts, and ledger balance otherwise. May be null for external accounts that have not yet been synced with balance data.
     * @type {number}
     * @memberof AccountBalance
     */
    readonly primary?: number | null;
    /**
     * The funds immediately available to use, including any pending transactions or temporary holds on the account. May be null for external accounts that have not yet been synced with balance data.
     * @type {number}
     * @memberof AccountBalance
     */
    readonly available?: number | null;
    /**
     * The total amount of funds in the account not including temporary holds or pending transactions. May be null for external accounts that have not yet been synced with balance data.
     * @type {number}
     * @memberof AccountBalance
     */
