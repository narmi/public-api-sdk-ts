...
export function ScheduledUnverifiedACHTransferToJSON(value?: Omit<ScheduledUnverifiedACHTransfer, 'uuid'|'next_transfer_at'|'dual_approval_state'|'display_state'> | null): any {
    if (value == null) {
        return value;
    }
    return {
