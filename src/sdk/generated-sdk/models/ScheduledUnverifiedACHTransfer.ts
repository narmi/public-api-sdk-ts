...
export function ScheduledUnverifiedACHTransferToJSON(value?: Omit<ScheduledUnverifiedACHTransfer, 'id'|'next_transfer_at'|'dual_approval_state'|'display_state'|'completed_at'> | null): any {
    if (value == null) {
        return value;
    }
    return {
