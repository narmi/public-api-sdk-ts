...
export function MobileAccountToJSON(value?: Omit<MobileAccount, 'name'|'nickname'|'id'|'number'|'type'|'product'|'updated_at'|'users'|'features'|'routing'|'loan_details'|'source'|'state'|'favorited'|'hidden'|'out_of_date'|'updated_from_source_at'|'check_micr'|'metadata'|'fi_name'|'created_at'|'verified'|'fi_svg'|'organization'> | null): any {
    if (value == null) {
        return value;
    }
    return {
