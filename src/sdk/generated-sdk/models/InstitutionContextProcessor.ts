...
export function InstitutionContextProcessorToJSON(value?: Omit<InstitutionContextProcessor, 'forgot_password_url'|'register_url'|'main_domain'|'short_name'|'routing_number'|'help_phone'|'help_email'|'help_card_phone'|'internal_name'|'terms_url'|'logo_url'|'s3_images_bucket'> | null): any {
    if (value == null) {
        return value;
    }
    return {
