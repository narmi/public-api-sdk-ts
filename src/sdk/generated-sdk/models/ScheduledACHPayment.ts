...
export function ScheduledACHPaymentToJSON(value?: Omit<ScheduledACHPayment, 'id'|'company_id'|'company_name'|'next_transfer_at'|'dual_approval_state'|'display_state'|'completed_at'|'transaction_type'> | null): any {
    if (value == null) {
        return value;
    }
    return {
