...
export function TransactionToJSON(value?: Omit<Transaction, 'description'|'raw_description'|'id'|'source'|'settled_at'|'created_at'|'account_id'|'category'|'sub_category'|'amount'|'ledger_balance'|'location'|'check'|'merchant'|'metadata'|'flex_plan_eligible'> | null): any {
    if (value == null) {
        return value;
    }
    return {
