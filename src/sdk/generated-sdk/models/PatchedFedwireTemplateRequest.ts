 ...
 * 
 * @export
 * @interface PatchedFedwireTemplateRequest
 */
export interface PatchedFedwireTemplateRequest {
    /**
     * The UUID of the wire recipient for wires sent using this template.
     * @type {string}
     * @memberof PatchedFedwireTemplateRequest
     */
    recipient: string;
    /**
...
/**
 * Check if a given object implements the PatchedFedwireTemplateRequest interface.
 */
export function instanceOfPatchedFedwireTemplateRequest(value: object): value is PatchedFedwireTemplateRequest {
...
export function PatchedFedwireTemplateRequestFromJSON(json: any): PatchedFedwireTemplateRequest {
    return PatchedFedwireTemplateRequestFromJSONTyped(json, false);
}

export function PatchedFedwireTemplateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchedFedwireTemplateRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchedFedwireTemplateRequestToJSON(value?: PatchedFedwireTemplateRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
