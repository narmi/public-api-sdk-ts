...
import type { FedwireRecipientAddress } from './FedwireRecipientAddress';
import {
    FedwireRecipientAddressFromJSON,
    FedwireRecipientAddressFromJSONTyped,
    FedwireRecipientAddressToJSON,
} from './FedwireRecipientAddress';
...
export interface FedwireDestination {
    ...
    /**
     * 
     * @type {FedwireRecipientAddress}
     * @memberof FedwireDestination
     */
    address: FedwireRecipientAddress;
    /**
     * 
     * @type {string}
     * @memberof FedwireDestination
...
export function FedwireDestinationFromJSONTyped(json: any, ignoreDiscriminator: boolean): FedwireDestination {
    ...
    return {
        ...
        'address': FedwireRecipientAddressFromJSON(json['address']),
...
export function FedwireDestinationToJSON(value?: Omit<FedwireDestination, 'id'|'institution_name'> | null): any {
    ...
    return {
        ...
        'address': FedwireRecipientAddressToJSON(value['address']),
    };
}
