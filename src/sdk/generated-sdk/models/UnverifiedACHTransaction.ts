...
import type { State40dEnum } from './State40dEnum';
import {
    State40dEnumFromJSON,
    State40dEnumFromJSONTyped,
    State40dEnumToJSON,
} from './State40dEnum';
 ...
 * 
 * @export
 * @interface UnverifiedACHTransaction
 */
export interface UnverifiedACHTransaction {
    /**
     * 
     * @type {string}
     * @memberof UnverifiedACHTransaction
     */
    readonly id?: string;
    /**
     * 
...
/**
 * Check if a given object implements the UnverifiedACHTransaction interface.
 */
export function instanceOfUnverifiedACHTransaction(value: object): value is UnverifiedACHTransaction {
...
export function UnverifiedACHTransactionFromJSON(json: any): UnverifiedACHTransaction {
    return UnverifiedACHTransactionFromJSONTyped(json, false);
}

export function UnverifiedACHTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): UnverifiedACHTransaction {
    if (json == null) {
        return json;
    }
    return {
        ...
        'state': json['state'] == null ? undefined : State40dEnumFromJSON(json['state']),
...
export function UnverifiedACHTransactionToJSON(value?: Omit<UnverifiedACHTransaction, 'id'|'created_at'|'updated_at'|'processed_at'|'state'|'display_state'|'company_id'|'company_name'|'external_account_details'> | null): any {
    if (value == null) {
        return value;
    }
    return {
