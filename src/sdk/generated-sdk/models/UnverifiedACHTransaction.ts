...
export function UnverifiedACHTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): UnverifiedACHTransaction {
    ...
    return {
        ...
        'reversal': json['reversal'] == null ? undefined : json['reversal'],
...
export function UnverifiedACHTransactionToJSON(value?: Omit<UnverifiedACHTransaction, 'id'|'created_at'|'updated_at'|'processed_at'|'state'|'display_state'|'is_reversible'|'reversal'|'company_id'|'company_name'|'external_account_details'> | null): any {
    if (value == null) {
        return value;
    }
    return {
