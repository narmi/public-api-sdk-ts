...
export interface CardInfo {
    ...
    cardType: string;
    /**
     * Whether this card is an HSA card, based on the matching Card image overrides BIN entry.
     * @type {boolean}
     * @memberof CardInfo
     */
    readonly isHsa?: boolean;
}
...
export function CardInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): CardInfo {
    ...
    return {
        ...
        'isHsa': json['is_hsa'] == null ? undefined : json['is_hsa'],
    };
}

export function CardInfoToJSON(value?: Omit<CardInfo, 'state'|'image'|'is_hsa'> | null): any {
    if (value == null) {
        return value;
    }
    return {
